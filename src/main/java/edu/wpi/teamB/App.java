...
public class App extends Application {
    ...
    public static final Path NODES_PATH = Paths.get("src/main/resources/edu/wpi/teamB/csvfiles/MapBNodes.csv");
    public static final Path EDGES_PATH = Paths.get("src/main/resources/edu/wpi/teamB/csvfiles/MapBEdges.csv");
