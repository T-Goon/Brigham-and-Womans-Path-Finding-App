...
public class App extends Application {
    ...
    private static final Path NODES_PATH = Paths.get("src/main/resources/edu/wpi/teamB/csvfiles/bwBnodes.csv");
    private static final Path EDGES_PATH = Paths.get("src/main/resources/edu/wpi/teamB/csvfiles/bwBedges.csv");
