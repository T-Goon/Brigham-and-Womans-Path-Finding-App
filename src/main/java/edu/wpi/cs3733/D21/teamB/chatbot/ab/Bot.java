...
import edu.wpi.cs3733.D21.teamB.chatbot.ab.utils.IOUtils;
...
//            if (folder.exists()) {
//                File[] listOfFiles = IOUtils.listFiles(aiml_path,
...
//            if (folder.exists()) {
//                File[] listOfFiles = IOUtils.listFiles(aimlif_path,
//                        new File(getClass().getProtectionDomain().getCodeSource().getLocation().getPath()));
...
//            if (folder.exists()) {
//                File[] listOfFiles = IOUtils.listFiles(sets_path,
//                        new File(getClass().getProtectionDomain().getCodeSource().getLocation().getPath()));
...
//            if (folder.exists()) {
//                File[] listOfFiles = IOUtils.listFiles(maps_path,
//                        new File(getClass().getProtectionDomain().getCodeSource().getLocation().getPath()));
