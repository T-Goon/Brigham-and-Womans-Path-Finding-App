...
public class PreProcessor {
    ...
    public String[] normalSubs = new String[org.alicebot.ab.MagicNumbers.max_substitutions];
    public Pattern[] normalPatterns = new Pattern[org.alicebot.ab.MagicNumbers.max_substitutions];
    public String[] denormalSubs = new String[org.alicebot.ab.MagicNumbers.max_substitutions];
    public Pattern[] denormalPatterns = new Pattern[org.alicebot.ab.MagicNumbers.max_substitutions];
    public String[] personSubs = new String[org.alicebot.ab.MagicNumbers.max_substitutions];
    public Pattern[] personPatterns = new Pattern[org.alicebot.ab.MagicNumbers.max_substitutions];
    public String[] person2Subs = new String[org.alicebot.ab.MagicNumbers.max_substitutions];
    public Pattern[] person2Patterns = new Pattern[org.alicebot.ab.MagicNumbers.max_substitutions];
    public String[] genderSubs = new String[org.alicebot.ab.MagicNumbers.max_substitutions];
    public Pattern[] genderPatterns = new Pattern[org.alicebot.ab.MagicNumbers.max_substitutions];
