...
import edu.wpi.cs3733.D21.teamB.games.snake.Snake_defunct_map_version;
...
public class StartGamePopupController implements Initializable {
    ...
    private Snake_defunct_map_version snake;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        snake = new Snake_defunct_map_version(popup.getData().getMd(), popup.getData().getMc(), popup.getData().getAp(), popup.getData().getScore());
        try {
            snakeImage = FXMLLoader.load(Objects.requireNonNull(Snake_defunct_map_version.class.getResource("/edu/wpi/cs3733/D21/teamB/views/map/misc/snake.fxml")));
