...
public class DatabaseHandlerTest {
    ...
    public void simpleParseNodes() {
        ...
        Node actual = CSVHandler.loadCSVNodes(nodes.toString()).get(0);
    ...
    public void complexParseNodesLength() {
        ...
        List<Node> nodes = CSVHandler.loadCSVNodes(nodePath.toString());
    ...
    public void simpleParseEdges() {
        ...
        Edge actual = CSVHandler.loadCSVEdges(edges.toString()).get(0);
        assertEquals(target.toString(), actual.toString());
    }
    ...
    public void complexParseEdgesLength() {
        ...
        List<Edge> nodes = CSVHandler.loadCSVEdges(nodePath.toString());
