...
public class DatabaseHandlerTest {
    ...
    static void initDB() {
        ...
        resourcesPath = "/edu/wpi/cs3733/D21/teamB/load";
        Graph.setGraph(db);
    ...
    public void testAddGetUser() {
        User user = new User("testuser", "", "Testing", "User", User.AuthenticationLevel.STAFF, "F", Collections.singletonList(Request.RequestType.LAUNDRY));
        try {
    ...
    public void testAuthentication() {
        User user = new User("testuser", "", "Testing", "User", User.AuthenticationLevel.STAFF, "F", Collections.singletonList(Request.RequestType.CASE_MANAGER));
        try {
            db.addUser(user, "password");
        } catch (SQLException e) {
            e.printStackTrace();
        ...
        assertEquals(new User(null, "", null, null, User.AuthenticationLevel.GUEST, "F", null),db.getAuthenticationUser());
    }
    ...
    public void testGetUserByJob() {
        ...
        User user1 = new User("testuser1", "", "Testing1", "User1", User.AuthenticationLevel.STAFF, "F", Collections.singletonList(Request.RequestType.FOOD));
        User user2 = new User("testuser2", "", "Testing2", "User2", User.AuthenticationLevel.STAFF, "F", Collections.singletonList(Request.RequestType.INTERNAL_TRANSPORT));
        User user3 = new User("testuser3", "", "Testing3", "User3", User.AuthenticationLevel.STAFF, "F", jobs);
    ...
    public void testUpdateUser() {
        User user = new User("testuser", "", "Testing", "User", User.AuthenticationLevel.STAFF, "F", Collections.singletonList(Request.RequestType.CASE_MANAGER));
        User altuser = new User("testuser", "", "Alternate", "User", User.AuthenticationLevel.ADMIN, User.CovidStatus.SAFE, "F", Collections.singletonList(Request.RequestType.FOOD));
        try {
            db.addUser(user, "password");
        } catch (SQLException e) {
            e.printStackTrace();
    ...
    public void testGetUsersByAuthenticationLevel() {
        User user = new User("testUser", "", "Testing", "User", User.AuthenticationLevel.STAFF, "F", Collections.singletonList(Request.RequestType.CASE_MANAGER));
        User altuser = new User("altUser", "", "Alternate", "User", User.AuthenticationLevel.ADMIN, "F", Collections.singletonList(Request.RequestType.FOOD));
    ...
    public void testGetUsers() {
        User user1 = new User("testuser1","","Testing1","User1", User.AuthenticationLevel.STAFF, "F", Collections.singletonList(Request.RequestType.FOOD));
        User user2 = new User("testuser2","","Testing2","User2", User.AuthenticationLevel.STAFF, "F", Collections.singletonList(Request.RequestType.INTERNAL_TRANSPORT));
        User user3 = new User("testuser3","","Testing3","User3", User.AuthenticationLevel.STAFF, "F", new ArrayList<>());
